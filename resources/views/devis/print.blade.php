...
<body>
    ...
    <main class="sheet">
        ...
        <footer class="footer"><div><img src="{{ asset('img/iso 9001.jpg') }}" alt="Certifié ISO 9001" class="iso-9001">@if($devis->notes)<div class="notes"><strong>Observations :</strong> {{ $devis->notes }}</div>@endif</div><div class="signature">Le laboratoire<br><br>Signature et cachet</div></footer>
    </main>
</body>
</html>