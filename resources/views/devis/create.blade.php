<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-900 leading-tight">Nouveau devis</h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('devis.store') }}" x-data="devisForm()" class="space-y-6">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="md:col-span-2" x-data="{ search: '', open: false }" @click.away="open = false">
                            <div class="flex items-center justify-between">
                                ...
                                <button type="button"
                                    @click="isWalkIn = !isWalkIn; selectedClientId = ''; search = ''; agents = [];"
                ...
                <div class="flex items-center justify-end gap-3">
                    <a href="{{ route('devis.index') }}" class="text-sm text-gray-600 hover:text-gray-900">Annuler</a>
